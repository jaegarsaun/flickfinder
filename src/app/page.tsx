    ...
    <main className="flex min-h-screen flex-col items-center justify-center p-24 h-[100vh]">
      <header className="hero flex flex-row w-full items-center justify-center h-full">
        <div className="flex flex-col items-center gap-10">
          ...
          <Link className="border-2 border-primary bg-transparent text-white rounded-lg p-3 text-center font-semibold w-[15vw] transition-all hover:bg-primary" href={'/play/settings'}>Start Playing</Link>
        </div>
      </header>
    </main>
  );
